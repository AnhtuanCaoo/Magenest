...
class Upload extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (isset($files['image'])){
            $background['image'] = $files['image'];
        }
        if (isset($background))
            try {
                $result           = $this->saveBackground($background['image']);
                $result['cookie'] = [
    ...
    public function saveBackground($files)
    {
        ...
        $result['url']  = $this->storeManager
                ...
                ) . $this->getFilePath('Blog/Image', $result['file']);
        $result['name'] = $result['file'];

        if (isset($result['file'])) {
            try {
                $relativePath = rtrim('Blog/Image', '/') . '/' . ltrim($result['file'], '/');
    ...
    {
        return $this->_authorization->isAllowed('Magenest_Forum::BlogImage');
    }
}
