    ...
    public function execute()
    {
        try {
            ...
            if (isset($params['access_token']) && isset($params['access_token'])) {
                ...
                if (is_array($accountIdentifiers) && !empty($accountIdentifiers) && isset($accountIdentifiers['merchantId'])) {
                    $this->_writerInterface->save(HelperData::GOOGLE_MERCHANT_ID, $accountIdentifiers['merchantId']);
                } else {
