...
namespace Magenest\ProductRecommendations\Block\Adminhtml;
...
class Log extends Container
{
    ...
    {
        return $this->directoryList->getPath('log') . DIRECTORY_SEPARATOR . 'product_log.log';
    }
    ...
    public function getLogContent()
    {
        ...
        try {
            ...
            {
                return '<pre>'."Product recommendations debug log is not readable or does not exist. File path: "
                    . $pathLogfile.'</pre>';
            }
